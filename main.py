...
main(grid_size=5, population_size=50, generations=100, initial_mutation_rate=1,
     alive_cells_weight=0.12, lifespan_weight=200, alive_growth_weight=0.03, stableness_weight = 0.001,
