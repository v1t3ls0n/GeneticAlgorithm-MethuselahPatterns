...
main(grid_size=10, population_size=50, generations=300, mutation_rate=0.2,
     alive_cells_weight=0.2, lifespan_weight=1000, alive_growth_weight=0.3, stableness_weight = 0.1,
